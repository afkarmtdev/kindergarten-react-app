...
export const translations = {
  en: {
    ...
    resumeAcceptedFormats: 'PDF, DOC, DOCX (max 5MB)',
  ...
  ms: {
    ...
    resumeAcceptedFormats: 'PDF, DOC, DOCX (maks 5MB)',
    fileTooLarge: 'Fail terlalu besar. Saiz maksimum 5MB.',
    invalidFileType: 'Jenis fail tidak sah. Sila muat naik PDF, DOC, atau DOCX.',
    closeModal: 'Tutup',
