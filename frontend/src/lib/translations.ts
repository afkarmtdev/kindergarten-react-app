export const translations = {
  en: {
    ...
    aboutChapterOne: 'Chapter one',
    aboutChapterTwo: 'Chapter two',
    aboutChapterThree: 'Chapter three',
    aboutStoryTitle: 'Our story',
    aboutStoryTitleYear: 'We opened our doors in {year}',
    aboutPrincipalTitle: 'A word from {name}',
  ...
  ms: {
    ...
    aboutChapterOne: 'Bab satu',
    aboutChapterTwo: 'Bab dua',
    aboutChapterThree: 'Bab tiga',
    aboutStoryTitle: 'Kisah kami',
    aboutStoryTitleYear: 'Kami membuka pintu pada {year}',
    aboutPrincipalTitle: 'Pesanan daripada {name}',
    viewPhoto: 'Lihat foto',
    previousPhoto: 'Foto sebelumnya',
    nextPhoto: 'Foto seterusnya',
    previousTestimonial: 'Testimoni sebelumnya',
    nextTestimonial: 'Testimoni seterusnya',
