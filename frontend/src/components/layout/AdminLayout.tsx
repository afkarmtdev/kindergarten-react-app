...
export function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-950 font-display transition-colors duration-200">
      {/* Sidebar */}
      <aside className="w-64 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 flex flex-col shadow-sm transition-colors duration-200">

        {/* Logo */}
        <div className="p-6 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-kinder-orange rounded-2xl flex items-center justify-center">
