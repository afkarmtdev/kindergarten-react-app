...
export function JobApplicationsPage() {
  ...
  return (
    <div className="p-4 md:p-8 space-y-6">
      ...
      {/* Table */}
      <div
        className={`bg-white dark:bg-gray-900 rounded-3xl shadow-sm border-2 border-gray-200 dark:border-gray-800 transition-opacity duration-200 ${isFetching && !isLoading ? 'opacity-60 pointer-events-none' : 'opacity-100'}`}
      >
