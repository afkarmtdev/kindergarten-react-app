...
import { Star, Heart, BookOpen, Sun, Music, Palette, Shield, Users, Moon, ArrowUp } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 font-display overflow-x-hidden transition-colors duration-200">
      ...
      <section id="programs" className="bg-white dark:bg-gray-950 py-24">
        ...
        {/* Wave: Features → Testimonials (purple) */}
        <div className="mt-16">
          <Wave fill="#C77DFF" />
        </div>
      </section>
      ...
      <section id="contact" className="bg-kinder-green py-24">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center overflow-hidden">
          ...
          <div className="relative flex flex-wrap gap-4 justify-center">
            ...
            <Link
              to="/admin/login"
              className="bg-white/20 border-2 border-white text-white px-10 py-4 rounded-full font-extrabold text-lg hover:-translate-y-1.5 hover:bg-white/30 transition-all duration-200"
            >
              {t('adminLogin')}
            </Link>
          </div>
