...
│       │   │   ├── UpdateBanner.tsx   # New-build strip (useVersionCheck); on the landing page the Reload tap also drops ReloadCurtain and leaves the sessionStorage hand-off flag
...
│       │   ├── reloadCurtain.ts   # isLandingPath(), markCurtainHandoff(), hasCurtainHandoff() (pure, StrictMode-safe), clearCurtainHandoff() + curtain timings — tested
